...
public class FMeasure {
  ...
  public FMeasure(long selected, long target, long truePositive){
  ...
  public static void main(String[] args) throws IOException, ParseException {
	  ...
	  System.out.printf("Quantos documentos você disse que não eram relevantes e acertou? ");
	  int falsoPositivo = ler.nextInt();
	  System.out.printf("Quantos documentos você disse que não eram relevantes e errou? ");
	  int falsoNegativo = ler.nextInt();
	  System.out.printf("Quantos documentos você disse que eram relevantes e acertou? ");
	  int truePositive = ler.nextInt();
	  System.out.printf("Quantos documentos você disse que eram relevantes e errou? ");
	  int trueNegative = ler.nextInt();
	  
	  int docsSelecionados = truePositive + trueNegative;
	  int alvo = truePositive + falsoNegativo;
	  
	  FMeasure fm = new FMeasure(docsSelecionados, alvo, truePositive);
